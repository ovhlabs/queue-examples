...
c.add_argument('--topic', metavar='topic', help='Topic, prefixed by your namespace (eg. --topic=myns.topic)')
c.add_argument('--username', metavar='username', help='SASL username, prefixed by your namespace (eg. --username=myns.user)')
c.add_argument('--password', metavar='password', help='SASL password')
c.add_argument('--consumer-group', metavar='consumer_group', help='Consumer group, prefixed by your SASL username (eg. --consumer-group=myns.user.g1)')
c.set_defaults(func=consume)

p = subparsers.add_parser('produce')
p.add_argument('--broker', metavar='broker', help='Kafka broker address')
p.add_argument('--topic', metavar='topic', help='Topic, prefixed by your namespace (eg. --topic=myns.topic)')
